...
同样是网络切换这一下，普通SSH直接断线重来，Mosh这边命令、光标全都还在原地——之前写过[Termux手机管理VPS教程](https://freedomgpt.top/2026/08/02/termux-vps-remote-manage/)，里面提到过用Mosh代替SSH能缓解这个问题，这篇展开说说具体是怎么回事、还有哪些别的办法。
...
如果断线之后发现连IPv6地址都连不上，那大概率不是这篇说的这两种情况，而是VPS本身的IPv6配置有问题，可以看这篇[IPv6 VPS服务无法访问的常见原因与排查方法](https://freedomgpt.top/2026/07/22/2026-07-22-005/)，从DNS解析和防火墙规则那几个方向查起。
