...
面板部分假设已经按[3x-ui安装教程](https://vpsjq.com/2026/04/30/2026-04-30-011/)装好。3x-ui 支持多种协议，普通 VLESS 是配置最简单的一种——不需要域名、不需要证书、不需要生成密钥对，几个基本参数填完就能用。代价是抗封锁能力比较差，流量特征明显，容易被识别和封锁，所以普通 VLESS 更适合测试用或者对安全性要求不高的临时场景，长期稳定使用建议换成 VLESS Reality，配置方法可以参考[3x-ui配置VLESS Reality节点教程](https://vpsjq.com/2026/08/27/3x-ui-vless-reality/)。
