  ...
  "@graph": [
    {
      ...
      "dateModified": "2026-09-02T12:00:00+08:00",
      ...
      "step": [
        {
          "@type": "HowToStep",
          "name": "下载运行老王工具箱",
          "text": "用wget下载ssh_tool.sh脚本并赋予执行权限后运行，跑完出现菜单，从菜单里选择安装Hysteria2的选项，脚本自动处理依赖安装和配置。"
        },
        {
          "@type": "HowToStep",
          "name": "验证服务是否运行",
          "text": "用systemctl status hysteria-server查看，显示active (running)说明服务在跑，也可以直接把节点导入客户端测试连接速度。"
        },
        {
          "@type": "HowToStep",
          "name": "放行UDP端口",
