  ...
  "@graph": [
    {
      ...
      "dateModified": "2026-08-28T14:00:00+08:00",
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "原版BBR从Linux 4.9进入主线内核，主流发行版直接可用；BBR2优化了带宽估算精度但一直没合并进主线内核，折腾成本高收益有限；BBRplus是第三方修改版发送策略更激进；BBR3是最新版本已合并进较新主线内核，XanMod内核内置支持。"
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "原版BBR、BBRplus、BBR3三个选一个就够了：内核够新直接开原版BBR最省事；想要更激进策略用BBRplus；已装XanMod内核直接用BBR3。这几个版本不需要叠加安装，混着装容易冲突，BBR2不太推荐普通用户折腾。"
          }
        }
      ]
    }
...
BBR3 是目前版本里最新的，已经合并进较新的 Linux 主线内核，XanMod 内核内置了 BBR3 支持，装好 XanMod 之后不需要额外配置就能用（XanMod本身的安装方法参考[一键更换为XanMod内核](https://vpsjq.com/2025/05/07/一键更换为xanmod内核/)，这篇只对比BBR各版本，不是XanMod的完整教程）。跟 BBRplus 类似，BBR3 在算法层面做了进一步优化，实际体验上比原版 BBR 好一些，但也不是换了就能翻倍提速的那种差距。
