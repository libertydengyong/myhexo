...
一键cat命令完成vps所有优化，以修改端口为9999例，包括安装xanmod,bbr+fq,mosh等等所有优化，<!-- more -->代码:
...
echo 'deb [signed-by=/usr/share/keyrings/xanmod.gpg] https://deb.xanmod.org releases main' > /etc/apt/sources.list.d/xanmod-release.list
