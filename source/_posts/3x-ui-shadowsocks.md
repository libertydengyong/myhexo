...
Shadowsocks 是最早流行起来的代理协议之一，配置简单，客户端支持广泛。面板部分假设已经按[3x-ui安装教程](https://vpsjq.com/2026/04/30/2026-04-30-011/)装好，3x-ui 支持 Shadowsocks，在入站列表里新建入站，协议选 Shadowsocks，选好加密方式就能用。不过实际使用下来，Shadowsocks 容易被封是一个绕不开的问题，长期稳定使用的话建议换更抗检测的协议。
